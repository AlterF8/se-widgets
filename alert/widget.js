...
window.addEventListener('onWidgetLoad', function (obj) {
    ...
    audioSub = new Audio('https://github.com/alterf8/se-widgets/blob/main/alert/assets/audio-sub.wav?raw=true')
    audioSub.volume = 0.25
    audioGift = new Audio('https://github.com/alterf8/se-widgets/blob/main/alert/assets/audio-gift.wav?raw=true')
    audioGift.volume = 0.25
    audioRaid = new Audio('https://github.com/alterf8/se-widgets/blob/main/alert/assets/audio-raid.wav?raw=true')
